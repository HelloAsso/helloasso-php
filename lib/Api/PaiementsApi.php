...
class PaiementsApi
{
    ...
    {
        $this->organizationsOrganizationSlugFormsFormTypeFormSlugPaymentsGetWithHttpInfo($organization_slug, $form_slug, $form_type, $from, $to, $user_search_key, $page_index, $page_size, $continuation_token, $states, $sort_order, $sort_field, $with_count, $contentType);
    }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\ResultsWithPaginationModelPayment|\OpenAPI\Client\Model\ResultsWithPaginationModelPayment|\OpenAPI\Client\Model\ResultsWithPaginationModelPayment
     */
    ...
    {
        list($response) = $this->organizationsOrganizationSlugPaymentsGetWithHttpInfo($organization_slug, $from, $to, $user_search_key, $page_index, $page_size, $continuation_token, $states, $sort_order, $sort_field, $with_count, $contentType);
        return $response;
    }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\ResultsWithPaginationModelPayment|\OpenAPI\Client\Model\ResultsWithPaginationModelPayment|\OpenAPI\Client\Model\ResultsWithPaginationModelPayment, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $this->paymentsPaymentIdGetWithHttpInfo($payment_id, $with_failed_refund_operation, $contentType);
    }
    ...
    {
        $this->paymentsPaymentIdRefundPostWithHttpInfo($payment_id, $comment, $cancel_order, $send_refund_mail, $amount, $contentType);
    }
