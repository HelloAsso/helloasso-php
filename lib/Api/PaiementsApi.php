...
class PaiementsApi
{
     ...
     * @param  \OpenAPI\Client\Model\HelloAssoApiV5ModelsEnumsSortOrder $sort_order Sort payments by ascending or descending order. Default is descending (optional)
     * @param  \OpenAPI\Client\Model\HelloAssoApiV5ModelsEnumsSortField $sort_field Sort payments by a specific field (Date or UpdateDate). Default is date (optional)
     ...
     * @param  \DateTime $from First Date Filter (optional)
     * @param  \DateTime $to End Date Filter (optional)
     * @param  int $page_size The number of items to retrieve (optional, default to 20)
     * @param  string $continuation_token Continuation Token from which we wish to retrieve results (optional)
     * @param  \OpenAPI\Client\Model\HelloAssoApiV5ModelsEnumsFormType[] $form_types The form type CrowdFunding, Membership, Event, Donation, PaymentForm, Checkout, Shop (optional)
     * @param  \OpenAPI\Client\Model\HelloAssoApiV5ModelsEnumsFormType $form_type The form type CrowdFunding, Membership, Event, Donation, PaymentForm, Checkout, Shop. This parameter must be used with the parameter formId. (optional)
     * @param  \OpenAPI\Client\Model\HelloAssoApiV5ModelsEnumsPaymentState[] $states Filter results by states of payments  Available values: * &#x60;Pending&#x60; - A payment scheduled at a later date, not yet processed. * &#x60;Authorized&#x60; - The payment has been authorized, validated, processed. * &#x60;Refused&#x60; - The payment has been refused by the bank. * &#x60;Unknown&#x60; * &#x60;Registered&#x60; - Represents a payment made offline.              Probably for an item of type * &#x60;Refunded&#x60; - The payment has been refunded. * &#x60;Refunding&#x60; - The payment is being refunded. * &#x60;Contested&#x60; - Payment has been contested by the contributor (optional)
     * @param  int $user_id The User identifier (optional)
     * @param  string $search_key Filter results on user or payer first name, last name or email. (optional)
     * @param  int $amount Amount of the payment in cents. Filter payments with exact amount with or without the contribution. (optional)
     * @param  \OpenAPI\Client\Model\HelloAssoApiV5ModelsEnumsSortOrder $sort_order Sort payments by ascending or descending order. Default is descending (optional)
     * @param  \OpenAPI\Client\Model\HelloAssoApiV5ModelsEnumsSortField $sort_field Sort payments by a specific field (Date or UpdateDate). Default is date (optional)
     ...
     * @param  bool $with_failed_refund_operation True to retrieve the refund operation in the states &#39;ABORTED&#39;, &#39;CANCELED&#39;, &#39;ERROR&#39;, &#39;REFUSED&#39;. (optional, default to false)
     ...
     *
     * @param  int $payment_id The payment identifier. (required)
     * @param  string $comment The comment about this refund. (optional)
     * @param  bool $cancel_order Whether the future payments and linked items of this order must be canceled (possible only if the payment is fully refunded) (optional, default to false)
     * @param  bool $send_refund_mail Whether a refund mail must be send or not. (optional, default to true)
     * @param  int $amount The amount in euros to refund. Enter this amount only for a partial refund for stripe. If not filled in then the entire payment is refunded (optional, default to 0)
