...
class PaiementsApi
{
    ...
    {
        list($response) = $this->organizationsOrganizationSlugFormsFormTypeFormSlugPaymentsGetWithHttpInfo($organization_slug, $form_slug, $form_type, $from, $to, $user_search_key, $page_index, $page_size, $continuation_token, $states, $sort_order, $sort_field, $contentType);
        return $response;
    }
    ...
    {
        return $this->organizationsOrganizationSlugFormsFormTypeFormSlugPaymentsGetAsyncWithHttpInfo($organization_slug, $form_slug, $form_type, $from, $to, $user_search_key, $page_index, $page_size, $continuation_token, $states, $sort_order, $sort_field, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @param  int|null $page_size The number of items per page (optional, default to 20)
     * @param  string|null $continuation_token Continuation Token from which we wish to retrieve results (optional)
     * @param  \OpenAPI\Client\Model\HelloAssoApiV5CommonModelsEnumsPaymentState[]|null $states The payment states  Available values: * &#x60;Pending&#x60; - A payment scheduled at a later date, not yet processed. * &#x60;Authorized&#x60; - The payment has been authorized, validated, processed. * &#x60;Refused&#x60; - The payment has been refused by the bank. * &#x60;Unknown&#x60; * &#x60;Registered&#x60; - Represents a payment made offline.             Probably for an item of type * &#x60;Refunded&#x60; - The payment has been refunded. * &#x60;Refunding&#x60; - The payment is being refunded. * &#x60;Contested&#x60; - Payment has been contested by the contributor * &#x60;WaitingBankValidation&#x60; - The payment is pending validation from the bank (used by SEPA direct debit). (optional)
     * @param  \OpenAPI\Client\Model\HelloAssoApiV5CommonModelsEnumsSortOrder|null $sort_order Sort payments by ascending or descending order. Default is descending (optional)
     * @param  \OpenAPI\Client\Model\HelloAssoApiV5CommonModelsEnumsSortField|null $sort_field Sort payments by a specific field (Date or UpdateDate). Default is date (optional)
    ...
    {
        list($response) = $this->organizationsOrganizationSlugPaymentsGetWithHttpInfo($organization_slug, $from, $to, $user_search_key, $page_index, $page_size, $continuation_token, $states, $sort_order, $sort_field, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function organizationsOrganizationSlugPaymentsGetAsync($organization_slug, $from = null, $to = null, $user_search_key = null, $page_index = 1, $page_size = 20, $continuation_token = null, $states = null, $sort_order = null, $sort_field = null, string $contentType = self::contentTypes['organizationsOrganizationSlugPaymentsGet'][0])
    {
        return $this->organizationsOrganizationSlugPaymentsGetAsyncWithHttpInfo($organization_slug, $from, $to, $user_search_key, $page_index, $page_size, $continuation_token, $states, $sort_order, $sort_field, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function organizationsOrganizationSlugPaymentsGetRequest($organization_slug, $from = null, $to = null, $user_search_key = null, $page_index = 1, $page_size = 20, $continuation_token = null, $states = null, $sort_order = null, $sort_field = null, string $contentType = self::contentTypes['organizationsOrganizationSlugPaymentsGet'][0])
    {
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\HelloAssoApiV5CommonModelsStatisticsPaymentDetail
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\HelloAssoApiV5CommonModelsStatisticsPaymentDetail, HTTP status code, HTTP response headers (array of strings)
     */
    public function paymentsPaymentIdGetWithHttpInfo($payment_id, $with_failed_refund_operation = false, string $contentType = self::contentTypes['paymentsPaymentIdGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\HelloAssoApiV5CommonModelsStatisticsPaymentDetail',
                        $request,
                        $response,
                    );
            }
    ...
    {
        $returnType = '\OpenAPI\Client\Model\HelloAssoApiV5CommonModelsStatisticsPaymentDetail';
        $request = $this->paymentsPaymentIdGetRequest($payment_id, $with_failed_refund_operation, $contentType);
     ...
     * @param  string|null $x_mfa_access_authorization Must be filled only if AuthorizationErrors.MFA.AccessTokenRequired error code was returned previously. (optional)
     * @param  string|null $x_mfa_sms_access_authorization Must be filled only if AuthorizationErrors.MFA.AccessOtpSmsRequired error code was returned previously. (optional)
     * @param  string|null $x_mfa_password_authorization Must be filled only if AuthorizationErrors.MFA.AccessPasswordTokenRequired error code was returned previously. (optional)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\HelloAssoApiV5CommonModelsPaymentRefundOperationModel
     */
    public function paymentsPaymentIdRefundPost($payment_id, $comment = null, $cancel_order = false, $send_refund_mail = true, $amount = 0, $x_mfa_access_authorization = null, $x_mfa_sms_access_authorization = null, $x_mfa_password_authorization = null, string $contentType = self::contentTypes['paymentsPaymentIdRefundPost'][0])
    {
        list($response) = $this->paymentsPaymentIdRefundPostWithHttpInfo($payment_id, $comment, $cancel_order, $send_refund_mail, $amount, $x_mfa_access_authorization, $x_mfa_sms_access_authorization, $x_mfa_password_authorization, $contentType);
        return $response;
    }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\HelloAssoApiV5CommonModelsPaymentRefundOperationModel, HTTP status code, HTTP response headers (array of strings)
     */
    public function paymentsPaymentIdRefundPostWithHttpInfo($payment_id, $comment = null, $cancel_order = false, $send_refund_mail = true, $amount = 0, $x_mfa_access_authorization = null, $x_mfa_sms_access_authorization = null, $x_mfa_password_authorization = null, string $contentType = self::contentTypes['paymentsPaymentIdRefundPost'][0])
    {
        $request = $this->paymentsPaymentIdRefundPostRequest($payment_id, $comment, $cancel_order, $send_refund_mail, $amount, $x_mfa_access_authorization, $x_mfa_sms_access_authorization, $x_mfa_password_authorization, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\HelloAssoApiV5CommonModelsPaymentRefundOperationModel',
                        $request,
                        $response,
                    );
            }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function paymentsPaymentIdRefundPostAsync($payment_id, $comment = null, $cancel_order = false, $send_refund_mail = true, $amount = 0, $x_mfa_access_authorization = null, $x_mfa_sms_access_authorization = null, $x_mfa_password_authorization = null, string $contentType = self::contentTypes['paymentsPaymentIdRefundPost'][0])
    {
        return $this->paymentsPaymentIdRefundPostAsyncWithHttpInfo($payment_id, $comment, $cancel_order, $send_refund_mail, $amount, $x_mfa_access_authorization, $x_mfa_sms_access_authorization, $x_mfa_password_authorization, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function paymentsPaymentIdRefundPostAsyncWithHttpInfo($payment_id, $comment = null, $cancel_order = false, $send_refund_mail = true, $amount = 0, $x_mfa_access_authorization = null, $x_mfa_sms_access_authorization = null, $x_mfa_password_authorization = null, string $contentType = self::contentTypes['paymentsPaymentIdRefundPost'][0])
    {
        $returnType = '\OpenAPI\Client\Model\HelloAssoApiV5CommonModelsPaymentRefundOperationModel';
        $request = $this->paymentsPaymentIdRefundPostRequest($payment_id, $comment, $cancel_order, $send_refund_mail, $amount, $x_mfa_access_authorization, $x_mfa_sms_access_authorization, $x_mfa_password_authorization, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function paymentsPaymentIdRefundPostRequest($payment_id, $comment = null, $cancel_order = false, $send_refund_mail = true, $amount = 0, $x_mfa_access_authorization = null, $x_mfa_sms_access_authorization = null, $x_mfa_password_authorization = null, string $contentType = self::contentTypes['paymentsPaymentIdRefundPost'][0])
    {
        ...
        // header params
        if ($x_mfa_access_authorization !== null) {
            $headerParams['x-mfa-access-authorization'] = ObjectSerializer::toHeaderValue($x_mfa_access_authorization);
        }
        // header params
        if ($x_mfa_sms_access_authorization !== null) {
            $headerParams['x-mfa-sms-access-authorization'] = ObjectSerializer::toHeaderValue($x_mfa_sms_access_authorization);
        }
        // header params
        if ($x_mfa_password_authorization !== null) {
            $headerParams['x-mfa-password-authorization'] = ObjectSerializer::toHeaderValue($x_mfa_password_authorization);
        }
