...
class CommandesApi
{
    ...
    public function itemsItemIdGetWithHttpInfo($item_id, $with_details = false, string $contentType = self::contentTypes['itemsItemIdGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\HelloAssoApiV5ModelsStatisticsItemDetail' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\HelloAssoApiV5ModelsStatisticsItemDetail' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\HelloAssoApiV5ModelsStatisticsItemDetail', []),
    ...
    public function ordersOrderIdGetWithHttpInfo($order_id, string $contentType = self::contentTypes['ordersOrderIdGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\HelloAssoApiV5ModelsStatisticsOrderDetail' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\HelloAssoApiV5ModelsStatisticsOrderDetail' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\HelloAssoApiV5ModelsStatisticsOrderDetail', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
     ...
     * @param  \OpenAPI\Client\Model\HelloAssoApiV5ModelsEnumsTierType[] $tier_types The type of tiers (optional)
     * @param  \OpenAPI\Client\Model\HelloAssoApiV5ModelsEnumsItemState[] $item_states The item states  Available values: * &#x60;Processed&#x60; - The item is paid and is valid * &#x60;Registered&#x60; - The item has been registered manually by the organization and is valid * &#x60;Unknown&#x60; * &#x60;Canceled&#x60; - The item has been canceled, and is no longer valid (optional)
     * @param  string $tier_name The name of a tier (optional)
     * @param  bool $with_details Set to true to return CustomFields and Options (optional, default to false)
     * @param  \OpenAPI\Client\Model\HelloAssoApiV5ModelsEnumsSortOrder $sort_order Sort forms items by ascending or descending order. Default is descending (optional)
     * @param  \OpenAPI\Client\Model\HelloAssoApiV5ModelsEnumsSortField $sort_field Sort forms items by a specific field (Date or UpdateDate). Default is date (optional)
     * @param  bool $with_count Whether the pagination should include totalCount and totalPages. (optional, default to true)
     ...
     * @param  \OpenAPI\Client\Model\HelloAssoApiV5ModelsEnumsSortOrder $sort_order Sort forms orders by ascending or descending order. Default is descending (optional)
     * @param  bool $with_count Whether the pagination should include totalCount and totalPages. (optional, default to true)
    ...
    public function organizationsOrganizationSlugFormsFormTypeFormSlugOrdersGetWithHttpInfo($organization_slug, $form_slug, $form_type, $from = null, $to = null, $user_search_key = null, $page_index = 1, $page_size = 20, $continuation_token = null, $with_details = false, $sort_order = null, $with_count = true, string $contentType = self::contentTypes['organizationsOrganizationSlugFormsFormTypeFormSlugOrdersGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ResultsWithPaginationModelOrder' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\ResultsWithPaginationModelOrder' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\ResultsWithPaginationModelOrder', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
     ...
     * @param  int $page_size The number of items per page (optional, default to 20)
     * @param  string $continuation_token Continuation Token from which we wish to retrieve results (optional)
     * @param  \OpenAPI\Client\Model\HelloAssoApiV5ModelsEnumsTierType[] $tier_types The type of tiers Donation, Payment, Registration, Membership, MonthlyDonation, MonthlyPayment, OfflineDonation, Contribution, Bonus (optional)
     * @param  \OpenAPI\Client\Model\HelloAssoApiV5ModelsEnumsItemState[] $item_states The item states  Available values: * &#x60;Processed&#x60; - The item is paid and is valid * &#x60;Registered&#x60; - The item has been registered manually by the organization and is valid * &#x60;Unknown&#x60; * &#x60;Canceled&#x60; - The item has been canceled, and is no longer valid (optional)
     * @param  string $tier_name The name of a tier (optional)
     * @param  bool $with_details Set to true to return CustomFields and Options (optional, default to false)
     * @param  \OpenAPI\Client\Model\HelloAssoApiV5ModelsEnumsSortOrder $sort_order Sort organizations items by ascending or descending order. Default is descending (optional)
     * @param  \OpenAPI\Client\Model\HelloAssoApiV5ModelsEnumsSortField $sort_field Sort organizations items by a specific field (Date or UpdateDate). Default is date (optional)
     * @param  bool $with_count Whether the pagination should include totalCount and totalPages. (optional, default to true)
     ...
     * @param  int $page_size The number of items per page (optional, default to 20)
     * @param  string $continuation_token Continuation Token from which we wish to retrieve results (optional)
     * @param  \OpenAPI\Client\Model\HelloAssoApiV5ModelsEnumsFormType[] $form_types The type of the form CrowdFunding, Membership, Event, Donation, PaymentForm, Checkout, Shop (optional)
     * @param  bool $with_details Set to true to return CustomFields (optional, default to false)
     * @param  \OpenAPI\Client\Model\HelloAssoApiV5ModelsEnumsSortOrder $sort_order Sort organizations orders by ascending or descending order. Default is descending (optional)
     * @param  bool $with_count Whether the pagination should include totalCount and totalPages. (optional, default to true)
