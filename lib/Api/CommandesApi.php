...
class CommandesApi
{
     ...
     */
    public function ordersOrderIdGet($order_id, $with_form_data = false, string $contentType = self::contentTypes['ordersOrderIdGet'][0])
    {
        list($response) = $this->ordersOrderIdGetWithHttpInfo($order_id, $with_form_data, $contentType);
        return $response;
    }
     ...
     */
    public function ordersOrderIdGetWithHttpInfo($order_id, $with_form_data = false, string $contentType = self::contentTypes['ordersOrderIdGet'][0])
    {
        $request = $this->ordersOrderIdGetRequest($order_id, $with_form_data, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ordersOrderIdGetAsync($order_id, $with_form_data = false, string $contentType = self::contentTypes['ordersOrderIdGet'][0])
    {
        return $this->ordersOrderIdGetAsyncWithHttpInfo($order_id, $with_form_data, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ordersOrderIdGetAsyncWithHttpInfo($order_id, $with_form_data = false, string $contentType = self::contentTypes['ordersOrderIdGet'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function ordersOrderIdGetRequest($order_id, $with_form_data = false, string $contentType = self::contentTypes['ordersOrderIdGet'][0])
    {
