...
class CommandesApi
{
     ...
     * @return \OpenAPI\Client\Model\HelloAssoApiV5CommonModelsStatisticsItemDetail
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\HelloAssoApiV5CommonModelsStatisticsItemDetail, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\OpenAPI\Client\Model\HelloAssoApiV5CommonModelsStatisticsItemDetail';
        $request = $this->itemsItemIdGetRequest($item_id, $with_details, $contentType);
     ...
     * @param  bool|null $with_form_data Set to true to include form data in the response (optional, default to false)
     * @param  bool|null $check_payments_refund_eligibility Set to true to check if payments are eligible to refund or not (optional, default to false)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\HelloAssoApiV5CommonModelsStatisticsOrderDetail
     */
    public function ordersOrderIdGet($order_id, $with_form_data = false, $check_payments_refund_eligibility = false, string $contentType = self::contentTypes['ordersOrderIdGet'][0])
    {
        list($response) = $this->ordersOrderIdGetWithHttpInfo($order_id, $with_form_data, $check_payments_refund_eligibility, $contentType);
        return $response;
    }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\HelloAssoApiV5CommonModelsStatisticsOrderDetail, HTTP status code, HTTP response headers (array of strings)
     */
    public function ordersOrderIdGetWithHttpInfo($order_id, $with_form_data = false, $check_payments_refund_eligibility = false, string $contentType = self::contentTypes['ordersOrderIdGet'][0])
    {
        $request = $this->ordersOrderIdGetRequest($order_id, $with_form_data, $check_payments_refund_eligibility, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ordersOrderIdGetAsync($order_id, $with_form_data = false, $check_payments_refund_eligibility = false, string $contentType = self::contentTypes['ordersOrderIdGet'][0])
    {
        return $this->ordersOrderIdGetAsyncWithHttpInfo($order_id, $with_form_data, $check_payments_refund_eligibility, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ordersOrderIdGetAsyncWithHttpInfo($order_id, $with_form_data = false, $check_payments_refund_eligibility = false, string $contentType = self::contentTypes['ordersOrderIdGet'][0])
    {
        $returnType = '\OpenAPI\Client\Model\HelloAssoApiV5CommonModelsStatisticsOrderDetail';
        $request = $this->ordersOrderIdGetRequest($order_id, $with_form_data, $check_payments_refund_eligibility, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function ordersOrderIdGetRequest($order_id, $with_form_data = false, $check_payments_refund_eligibility = false, string $contentType = self::contentTypes['ordersOrderIdGet'][0])
    {
        ...
        // query params
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $check_payments_refund_eligibility,
            'checkPaymentsRefundEligibility', // param base name
            'boolean', // openApiType
            'form', // style
            true, // explode
            false // required
     ...
     * @param  \OpenAPI\Client\Model\HelloAssoApiV5CommonModelsEnumsFormType $form_type The form type CrowdFunding, Membership, Event, Donation, PaymentForm, Checkout, Shop (required)
     ...
     * @param  \OpenAPI\Client\Model\HelloAssoApiV5CommonModelsEnumsTierType[]|null $tier_types The type of tiers (optional)
     * @param  \OpenAPI\Client\Model\HelloAssoApiV5CommonModelsEnumsItemState[]|null $item_states The item states  Available values: * &#x60;Processed&#x60; - The item is paid and is valid * &#x60;Registered&#x60; - The item has been registered manually by the organization and is valid * &#x60;Unknown&#x60; * &#x60;Canceled&#x60; - The item has been canceled, and is no longer valid (optional)
     * @param  string|null $tier_name The name of a tier (optional)
     * @param  bool|null $with_details Set to true to return CustomFields and Options (optional, default to false)
     * @param  \OpenAPI\Client\Model\HelloAssoApiV5CommonModelsEnumsSortOrder|null $sort_order Sort forms items by ascending or descending order. Default is descending (optional)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function organizationsOrganizationSlugFormsFormTypeFormSlugItemsGetWithHttpInfo($organization_slug, $form_slug, $form_type, $from = null, $to = null, $user_search_key = null, $page_index = 1, $page_size = 20, $continuation_token = null, $tier_types = null, $item_states = null, $tier_name = null, $with_details = false, $sort_order = null, $sort_field = null, string $contentType = self::contentTypes['organizationsOrganizationSlugFormsFormTypeFormSlugItemsGet'][0])
    {
        $request = $this->organizationsOrganizationSlugFormsFormTypeFormSlugItemsGetRequest($organization_slug, $form_slug, $form_type, $from, $to, $user_search_key, $page_index, $page_size, $continuation_token, $tier_types, $item_states, $tier_name, $with_details, $sort_order, $sort_field, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function organizationsOrganizationSlugFormsFormTypeFormSlugItemsGetAsync($organization_slug, $form_slug, $form_type, $from = null, $to = null, $user_search_key = null, $page_index = 1, $page_size = 20, $continuation_token = null, $tier_types = null, $item_states = null, $tier_name = null, $with_details = false, $sort_order = null, $sort_field = null, string $contentType = self::contentTypes['organizationsOrganizationSlugFormsFormTypeFormSlugItemsGet'][0])
    {
        return $this->organizationsOrganizationSlugFormsFormTypeFormSlugItemsGetAsyncWithHttpInfo($organization_slug, $form_slug, $form_type, $from, $to, $user_search_key, $page_index, $page_size, $continuation_token, $tier_types, $item_states, $tier_name, $with_details, $sort_order, $sort_field, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    public function organizationsOrganizationSlugFormsFormTypeFormSlugItemsGetRequest($organization_slug, $form_slug, $form_type, $from = null, $to = null, $user_search_key = null, $page_index = 1, $page_size = 20, $continuation_token = null, $tier_types = null, $item_states = null, $tier_name = null, $with_details = false, $sort_order = null, $sort_field = null, string $contentType = self::contentTypes['organizationsOrganizationSlugFormsFormTypeFormSlugItemsGet'][0])
    {
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            ...
            'HelloAssoApiV5CommonModelsEnumsSortOrder', // openApiType
            'form', // style
            true, // explode
            false // required
        ) ?? []);
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            ...
            'HelloAssoApiV5CommonModelsEnumsSortField', // openApiType
            'form', // style
            true, // explode
            false // required
        ) ?? []);
     ...
     * @param  \OpenAPI\Client\Model\HelloAssoApiV5CommonModelsEnumsSortOrder|null $sort_order Sort forms orders by ascending or descending order. Default is descending (optional)
    ...
    {
        list($response) = $this->organizationsOrganizationSlugFormsFormTypeFormSlugOrdersGetWithHttpInfo($organization_slug, $form_slug, $form_type, $from, $to, $user_search_key, $page_index, $page_size, $continuation_token, $with_details, $sort_order, $contentType);
        return $response;
    }
    ...
    {
        return $this->organizationsOrganizationSlugFormsFormTypeFormSlugOrdersGetAsyncWithHttpInfo($organization_slug, $form_slug, $form_type, $from, $to, $user_search_key, $page_index, $page_size, $continuation_token, $with_details, $sort_order, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @param  int|null $page_size The number of items per page (optional, default to 20)
     * @param  string|null $continuation_token Continuation Token from which we wish to retrieve results (optional)
     * @param  \OpenAPI\Client\Model\HelloAssoApiV5CommonModelsEnumsTierType[]|null $tier_types The type of tiers Donation, Payment, Registration, Membership, MonthlyDonation, MonthlyPayment, OfflineDonation, Contribution, Bonus (optional)
     * @param  \OpenAPI\Client\Model\HelloAssoApiV5CommonModelsEnumsItemState[]|null $item_states The item states  Available values: * &#x60;Processed&#x60; - The item is paid and is valid * &#x60;Registered&#x60; - The item has been registered manually by the organization and is valid * &#x60;Unknown&#x60; * &#x60;Canceled&#x60; - The item has been canceled, and is no longer valid (optional)
     * @param  string|null $tier_name The name of a tier (optional)
     * @param  bool|null $with_details Set to true to return CustomFields and Options (optional, default to false)
     * @param  \OpenAPI\Client\Model\HelloAssoApiV5CommonModelsEnumsSortOrder|null $sort_order Sort organizations items by ascending or descending order. Default is descending (optional)
     * @param  \OpenAPI\Client\Model\HelloAssoApiV5CommonModelsEnumsSortField|null $sort_field Sort organizations items by a specific field (Date or UpdateDate). Default is date (optional)
     ...
     * @return void
     */
    public function organizationsOrganizationSlugItemsGet($organization_slug, $from = null, $to = null, $user_search_key = null, $page_index = 1, $page_size = 20, $continuation_token = null, $tier_types = null, $item_states = null, $tier_name = null, $with_details = false, $sort_order = null, $sort_field = null, string $contentType = self::contentTypes['organizationsOrganizationSlugItemsGet'][0])
    {
        $this->organizationsOrganizationSlugItemsGetWithHttpInfo($organization_slug, $from, $to, $user_search_key, $page_index, $page_size, $continuation_token, $tier_types, $item_states, $tier_name, $with_details, $sort_order, $sort_field, $contentType);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function organizationsOrganizationSlugItemsGetWithHttpInfo($organization_slug, $from = null, $to = null, $user_search_key = null, $page_index = 1, $page_size = 20, $continuation_token = null, $tier_types = null, $item_states = null, $tier_name = null, $with_details = false, $sort_order = null, $sort_field = null, string $contentType = self::contentTypes['organizationsOrganizationSlugItemsGet'][0])
    {
        $request = $this->organizationsOrganizationSlugItemsGetRequest($organization_slug, $from, $to, $user_search_key, $page_index, $page_size, $continuation_token, $tier_types, $item_states, $tier_name, $with_details, $sort_order, $sort_field, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function organizationsOrganizationSlugItemsGetAsync($organization_slug, $from = null, $to = null, $user_search_key = null, $page_index = 1, $page_size = 20, $continuation_token = null, $tier_types = null, $item_states = null, $tier_name = null, $with_details = false, $sort_order = null, $sort_field = null, string $contentType = self::contentTypes['organizationsOrganizationSlugItemsGet'][0])
    {
        return $this->organizationsOrganizationSlugItemsGetAsyncWithHttpInfo($organization_slug, $from, $to, $user_search_key, $page_index, $page_size, $continuation_token, $tier_types, $item_states, $tier_name, $with_details, $sort_order, $sort_field, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function organizationsOrganizationSlugItemsGetAsyncWithHttpInfo($organization_slug, $from = null, $to = null, $user_search_key = null, $page_index = 1, $page_size = 20, $continuation_token = null, $tier_types = null, $item_states = null, $tier_name = null, $with_details = false, $sort_order = null, $sort_field = null, string $contentType = self::contentTypes['organizationsOrganizationSlugItemsGet'][0])
    {
        $returnType = '';
        $request = $this->organizationsOrganizationSlugItemsGetRequest($organization_slug, $from, $to, $user_search_key, $page_index, $page_size, $continuation_token, $tier_types, $item_states, $tier_name, $with_details, $sort_order, $sort_field, $contentType);
     ...
     * @param  int|null $page_size The number of items per page (optional, default to 20)
     * @param  string|null $continuation_token Continuation Token from which we wish to retrieve results (optional)
     * @param  \OpenAPI\Client\Model\HelloAssoApiV5CommonModelsEnumsFormType[]|null $form_types The type of the form CrowdFunding, Membership, Event, Donation, PaymentForm, Checkout, Shop (optional)
     * @param  bool|null $with_details Set to true to return CustomFields (optional, default to false)
     * @param  \OpenAPI\Client\Model\HelloAssoApiV5CommonModelsEnumsSortOrder|null $sort_order Sort organizations orders by ascending or descending order. Default is descending (optional)
    ...
    {
        list($response) = $this->organizationsOrganizationSlugOrdersGetWithHttpInfo($organization_slug, $from, $to, $user_search_key, $page_index, $page_size, $continuation_token, $form_types, $with_details, $sort_order, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function organizationsOrganizationSlugOrdersGetAsync($organization_slug, $from = null, $to = null, $user_search_key = null, $page_index = 1, $page_size = 20, $continuation_token = null, $form_types = null, $with_details = false, $sort_order = null, string $contentType = self::contentTypes['organizationsOrganizationSlugOrdersGet'][0])
    {
        return $this->organizationsOrganizationSlugOrdersGetAsyncWithHttpInfo($organization_slug, $from, $to, $user_search_key, $page_index, $page_size, $continuation_token, $form_types, $with_details, $sort_order, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function organizationsOrganizationSlugOrdersGetRequest($organization_slug, $from = null, $to = null, $user_search_key = null, $page_index = 1, $page_size = 20, $continuation_token = null, $form_types = null, $with_details = false, $sort_order = null, string $contentType = self::contentTypes['organizationsOrganizationSlugOrdersGet'][0])
    {
