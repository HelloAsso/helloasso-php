...
class CommandesApi
{
    ...
    {
        $this->itemsItemIdGetWithHttpInfo($item_id, $with_details, $contentType);
    }
    ...
    {
        $this->ordersOrderIdGetWithHttpInfo($order_id, $contentType);
    }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\ResultsWithPaginationModelItem|\OpenAPI\Client\Model\ResultsWithPaginationModelItem|\OpenAPI\Client\Model\ResultsWithPaginationModelItem
     */
    ...
    {
        list($response) = $this->organizationsOrganizationSlugFormsFormTypeFormSlugItemsGetWithHttpInfo($organization_slug, $form_slug, $form_type, $from, $to, $user_search_key, $page_index, $page_size, $continuation_token, $tier_types, $item_states, $tier_name, $with_details, $sort_order, $sort_field, $with_count, $contentType);
        return $response;
    }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\ResultsWithPaginationModelItem|\OpenAPI\Client\Model\ResultsWithPaginationModelItem|\OpenAPI\Client\Model\ResultsWithPaginationModelItem, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\ResultsWithPaginationModelItem',
                        $request,
                        $response,
                    );
                case 401:
    ...
    {
        $returnType = '\OpenAPI\Client\Model\ResultsWithPaginationModelItem';
        $request = $this->organizationsOrganizationSlugFormsFormTypeFormSlugItemsGetRequest($organization_slug, $form_slug, $form_type, $from, $to, $user_search_key, $page_index, $page_size, $continuation_token, $tier_types, $item_states, $tier_name, $with_details, $sort_order, $sort_field, $with_count, $contentType);
    ...
    {
        $this->organizationsOrganizationSlugFormsFormTypeFormSlugOrdersGetWithHttpInfo($organization_slug, $form_slug, $form_type, $from, $to, $user_search_key, $page_index, $page_size, $continuation_token, $with_details, $sort_order, $with_count, $contentType);
    }
    ...
    {
        list($response) = $this->organizationsOrganizationSlugItemsGetWithHttpInfo($organization_slug, $from, $to, $user_search_key, $page_index, $page_size, $continuation_token, $tier_types, $item_states, $tier_name, $with_details, $sort_order, $sort_field, $with_count, $contentType);
        return $response;
    }
    ...
    {
        $this->organizationsOrganizationSlugOrdersGetWithHttpInfo($organization_slug, $from, $to, $user_search_key, $page_index, $page_size, $continuation_token, $form_types, $with_details, $sort_order, $with_count, $contentType);
    }
