...
class HelloAssoApiV5ModelsOrganizationLegalInformationsUpdateOrganizationLegalInformationConfigurationBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $attributeMap = [
        ...
        'is_helloasso_transmitter' => 'isHelloassoTransmitter'
    ];
    ...
    protected static $setters = [
        ...
        'is_helloasso_transmitter' => 'setIsHelloassoTransmitter'
    ];
    ...
    protected static $getters = [
        ...
        'is_helloasso_transmitter' => 'getIsHelloassoTransmitter'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('is_helloasso_transmitter', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets is_coluche
     *
     * @param bool|null $is_coluche is_coluche
     *
     * @return self
     */
     ...
     *
     * @param bool|null $allow_ifi_tax_reductions allow_ifi_tax_reductions
     *
     * @return self
     */
    ...
    /**
     * Gets is_helloasso_transmitter
     *
     * @return bool|null
     */
    public function getIsHelloassoTransmitter()
    {
        return $this->container['is_helloasso_transmitter'];
    }

    /**
     * Sets is_helloasso_transmitter
     *
     * @param bool|null $is_helloasso_transmitter is_helloasso_transmitter
     *
     * @return self
     */
    public function setIsHelloassoTransmitter($is_helloasso_transmitter)
    {
        if (is_null($is_helloasso_transmitter)) {
            array_push($this->openAPINullablesSetToNull, 'is_helloasso_transmitter');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('is_helloasso_transmitter', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['is_helloasso_transmitter'] = $is_helloasso_transmitter;
