...
/**
 * HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'HelloAsso.Api.V5.Common.Models.Forms.FormQuickCreateRequest';
    ...
    protected static $openAPITypes = [
        'tier_list' => '\OpenAPI\Client\Model\HelloAssoApiV5CommonModelsFormsTierLightModel[]',
        'banner' => 'string',
        'description' => 'string',
        'end_date' => '\DateTime',
        'logo' => 'string',
        ...
        'place' => '\OpenAPI\Client\Model\HelloAssoApiV5CommonModelsCommonPlaceModel',
        'sale_end_date' => '\DateTime',
        'sale_start_date' => '\DateTime',
        'validity_type' => '\OpenAPI\Client\Model\HelloAssoApiV5CommonModelsEnumsMembershipValidityType',
        ...
        'contact' => '\OpenAPI\Client\Model\HelloAssoApiV5CommonModelsCommonContactModel',
        ...
        'suggest_monthly_donation' => 'bool',
        'display_monthly_donations_first' => 'bool',
        'project_target_country' => 'string',
        'allow_organism_payer' => 'bool',
        'allow_individual_payer' => 'bool',
        'remind_abandoned_cart' => 'bool',
        'display_version' => 'int',
        'max_entries' => 'int'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'project_owners' => null,
        'suggest_monthly_donation' => null,
        'display_monthly_donations_first' => null,
        'project_target_country' => null,
        'allow_organism_payer' => null,
        'allow_individual_payer' => null,
        'remind_abandoned_cart' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'project_owners' => true,
        'suggest_monthly_donation' => false,
        'display_monthly_donations_first' => false,
        'project_target_country' => true,
        'allow_organism_payer' => false,
        'allow_individual_payer' => false,
        'remind_abandoned_cart' => false,
    ...
    protected static $attributeMap = [
        ...
        'suggest_monthly_donation' => 'suggestMonthlyDonation',
        'display_monthly_donations_first' => 'displayMonthlyDonationsFirst',
        ...
        'remind_abandoned_cart' => 'remindAbandonedCart',
    ...
    protected static $setters = [
        ...
        'suggest_monthly_donation' => 'setSuggestMonthlyDonation',
        'display_monthly_donations_first' => 'setDisplayMonthlyDonationsFirst',
        ...
        'remind_abandoned_cart' => 'setRemindAbandonedCart',
    ...
    protected static $getters = [
        ...
        'suggest_monthly_donation' => 'getSuggestMonthlyDonation',
        'display_monthly_donations_first' => 'getDisplayMonthlyDonationsFirst',
        ...
        'remind_abandoned_cart' => 'getRemindAbandonedCart',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('suggest_monthly_donation', $data ?? [], null);
        $this->setIfExists('display_monthly_donations_first', $data ?? [], null);
        ...
        $this->setIfExists('remind_abandoned_cart', $data ?? [], null);
     ...
     * Gets tier_list
     *
     * @return \OpenAPI\Client\Model\HelloAssoApiV5CommonModelsFormsTierLightModel[]|null
     */
     ...
     * Sets tier_list
     *
     * @param \OpenAPI\Client\Model\HelloAssoApiV5CommonModelsFormsTierLightModel[]|null $tier_list tier_list
     *
     * @return self
     */
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest., must be bigger than or equal to 1.');
        }
     ...
     * Gets place
     *
     * @return \OpenAPI\Client\Model\HelloAssoApiV5CommonModelsCommonPlaceModel|null
     */
     ...
     * Sets place
     *
     * @param \OpenAPI\Client\Model\HelloAssoApiV5CommonModelsCommonPlaceModel|null $place place
     *
     * @return self
     */
     ...
     * Gets validity_type
     *
     * @return \OpenAPI\Client\Model\HelloAssoApiV5CommonModelsEnumsMembershipValidityType|null
     */
     ...
     * Sets validity_type
     *
     * @param \OpenAPI\Client\Model\HelloAssoApiV5CommonModelsEnumsMembershipValidityType|null $validity_type validity_type
     *
     * @return self
     */
     ...
     * Gets contact
     *
     * @return \OpenAPI\Client\Model\HelloAssoApiV5CommonModelsCommonContactModel|null
     */
     ...
     * Sets contact
     *
     * @param \OpenAPI\Client\Model\HelloAssoApiV5CommonModelsCommonContactModel|null $contact contact
     *
     * @return self
     */
     ...
     *
     * @param bool|null $display_contributor_name Display contributor name for fundraiser and donation forms.
     *
     * @return self
     */
    ...
    /**
     * Gets suggest_monthly_donation
     *
     * @return bool|null
     */
    public function getSuggestMonthlyDonation()
    {
        return $this->container['suggest_monthly_donation'];
    }

    /**
     * Sets suggest_monthly_donation
     *
     * @param bool|null $suggest_monthly_donation Suggest monthly donation for donation forms.
     *
     * @return self
     */
    public function setSuggestMonthlyDonation($suggest_monthly_donation)
    {
        if (is_null($suggest_monthly_donation)) {
            throw new \InvalidArgumentException('non-nullable suggest_monthly_donation cannot be null');
        }
        $this->container['suggest_monthly_donation'] = $suggest_monthly_donation;

        return $this;
    }

    /**
     * Gets display_monthly_donations_first
     *
     * @return bool|null
     */
    public function getDisplayMonthlyDonationsFirst()
    {
        return $this->container['display_monthly_donations_first'];
    }

    /**
     * Sets display_monthly_donations_first
     *
     * @param bool|null $display_monthly_donations_first The monthly donation option should be displayed or selected by default for donation forms.
     *
     * @return self
     */
    public function setDisplayMonthlyDonationsFirst($display_monthly_donations_first)
    {
        if (is_null($display_monthly_donations_first)) {
            throw new \InvalidArgumentException('non-nullable display_monthly_donations_first cannot be null');
        }
        $this->container['display_monthly_donations_first'] = $display_monthly_donations_first;
    ...
    public function setProjectTargetCountry($project_target_country)
    {
        ...
        if (!is_null($project_target_country) && (mb_strlen($project_target_country) > 3)) {
            throw new \InvalidArgumentException('invalid length for $project_target_country when calling HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest., must be smaller than or equal to 3.');
        }
        if (!is_null($project_target_country) && (mb_strlen($project_target_country) < 3)) {
            throw new \InvalidArgumentException('invalid length for $project_target_country when calling HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest., must be bigger than or equal to 3.');
        }
    ...
    /**
     * Gets remind_abandoned_cart
     *
     * @return bool|null
     */
    public function getRemindAbandonedCart()
    {
        return $this->container['remind_abandoned_cart'];
    }

    /**
     * Sets remind_abandoned_cart
     *
     * @param bool|null $remind_abandoned_cart Whether a reminder email should be sent for abandoned carts.
     *
     * @return self
     */
    public function setRemindAbandonedCart($remind_abandoned_cart)
    {
        if (is_null($remind_abandoned_cart)) {
            throw new \InvalidArgumentException('non-nullable remind_abandoned_cart cannot be null');
        }
        $this->container['remind_abandoned_cart'] = $remind_abandoned_cart;
     ...
     *
     * @param int|null $display_version The form display version (only for membership).
     *
     * @return self
     */
