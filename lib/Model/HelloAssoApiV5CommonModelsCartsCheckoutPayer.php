...
/**
 * HelloAssoApiV5CommonModelsCartsCheckoutPayer Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class HelloAssoApiV5CommonModelsCartsCheckoutPayer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HelloAsso.Api.V5.Common.Models.Carts.CheckoutPayer';
    ...
    */
    ...
    public function setFirstName($first_name)
    {
        ...
        if (!is_null($first_name) && (mb_strlen($first_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling HelloAssoApiV5CommonModelsCartsCheckoutPayer., must be smaller than or equal to 255.');
        }
    ...
    public function setLastName($last_name)
    {
        ...
        if (!is_null($last_name) && (mb_strlen($last_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling HelloAssoApiV5CommonModelsCartsCheckoutPayer., must be smaller than or equal to 255.');
        }
    ...
    public function setEmail($email)
    {
        ...
        if (!is_null($email) && (mb_strlen($email) > 255)) {
            throw new \InvalidArgumentException('invalid length for $email when calling HelloAssoApiV5CommonModelsCartsCheckoutPayer., must be smaller than or equal to 255.');
        }
    ...
    public function setCountry($country)
    {
        ...
        if (!is_null($country) && (mb_strlen($country) > 3)) {
            throw new \InvalidArgumentException('invalid length for $country when calling HelloAssoApiV5CommonModelsCartsCheckoutPayer., must be smaller than or equal to 3.');
        }
        if (!is_null($country) && (mb_strlen($country) < 3)) {
            throw new \InvalidArgumentException('invalid length for $country when calling HelloAssoApiV5CommonModelsCartsCheckoutPayer., must be bigger than or equal to 3.');
        }
    ...
    public function setCompanyName($company_name)
    {
        ...
        if (!is_null($company_name) && (mb_strlen($company_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $company_name when calling HelloAssoApiV5CommonModelsCartsCheckoutPayer., must be smaller than or equal to 255.');
        }
