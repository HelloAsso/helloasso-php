...
/**
 * HelloAssoApiV5CommonModelsAccountsClientsApiClientModel Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class HelloAssoApiV5CommonModelsAccountsClientsApiClientModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HelloAsso.Api.V5.Common.Models.Accounts.Clients.ApiClientModel';
    ...
    */
     ...
     * Sets secret
     *
     * @param string|null $secret Filled only when requested by the organization back office
     *
     * @return self
     */
    ...
    public function setPrivileges($privileges)
    {
        if (is_null($privileges)) {
            array_push($this->openAPINullablesSetToNull, 'privileges');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('privileges', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
