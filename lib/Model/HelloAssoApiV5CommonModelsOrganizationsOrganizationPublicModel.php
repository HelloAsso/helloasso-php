...
/**
 * HelloAssoApiV5CommonModelsOrganizationsOrganizationPublicModel Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class HelloAssoApiV5CommonModelsOrganizationsOrganizationPublicModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'HelloAsso.Api.V5.Common.Models.Organizations.OrganizationPublicModel';
    ...
    protected static $openAPITypes = [
        ...
        'gallery_images' => '\OpenAPI\Client\Model\HelloAssoApiV5CommonModelsCommonImageModel[]',
        'long_description' => 'string',
        'twitter_page' => 'string',
        'videos' => '\OpenAPI\Client\Model\HelloAssoApiV5CommonModelsCommonVideoModel[]',
        'web_site' => 'string',
        ...
        'type' => '\OpenAPI\Client\Model\HelloAssoApiV5CommonModelsEnumsOrganizationType',
        'category' => 'string',
        'address' => 'string',
    ...
    protected static $setters = [
        ...
        'twitter_page' => 'setTwitterPage',
        'videos' => 'setVideos',
        'web_site' => 'setWebSite',
        'is_authenticated' => 'setIsAuthenticated',
        'display_coordinates' => 'setDisplayCoordinates',
    ...
    protected static $getters = [
        ...
        'twitter_page' => 'getTwitterPage',
        'videos' => 'getVideos',
        'web_site' => 'getWebSite',
        'is_authenticated' => 'getIsAuthenticated',
        'display_coordinates' => 'getDisplayCoordinates',
     ...
     * Sets facebook_page
     *
     * @param string|null $facebook_page facebook_page
     *
     * @return self
     */
    public function setFacebookPage($facebook_page)
    {
        if (is_null($facebook_page)) {
            array_push($this->openAPINullablesSetToNull, 'facebook_page');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('facebook_page', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Gets gallery_images
     *
     * @return \OpenAPI\Client\Model\HelloAssoApiV5CommonModelsCommonImageModel[]|null
     */
     ...
     * Sets gallery_images
     *
     * @param \OpenAPI\Client\Model\HelloAssoApiV5CommonModelsCommonImageModel[]|null $gallery_images gallery_images
     *
     * @return self
     */
    ...
    {
        return $this->container['twitter_page'];
    }

    /**
     * Sets twitter_page
     *
     * @param string|null $twitter_page twitter_page
     *
     * @return self
     */
    public function setTwitterPage($twitter_page)
    {
        if (is_null($twitter_page)) {
            array_push($this->openAPINullablesSetToNull, 'twitter_page');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('twitter_page', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['twitter_page'] = $twitter_page;
     ...
     * Gets videos
     *
     * @return \OpenAPI\Client\Model\HelloAssoApiV5CommonModelsCommonVideoModel[]|null
     */
     ...
     * Sets videos
     *
     * @param \OpenAPI\Client\Model\HelloAssoApiV5CommonModelsCommonVideoModel[]|null $videos videos
     *
     * @return self
     */
    ...
    /**
     * Gets display_coordinates
     *
     * @return bool|null
     */
    public function getDisplayCoordinates()
    {
        return $this->container['display_coordinates'];
    }

    /**
     * Sets display_coordinates
     *
     * @param bool|null $display_coordinates If the organization chose to display its coordinates. Property returned only when asked by an organization admin.
     *
     * @return self
     */
    public function setDisplayCoordinates($display_coordinates)
    {
        if (is_null($display_coordinates)) {
            array_push($this->openAPINullablesSetToNull, 'display_coordinates');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('display_coordinates', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['display_coordinates'] = $display_coordinates;
     ...
     *
     * @param bool|null $is_cash_in_compliant If transaction can be init on the organization or not. Property returned only when asked by an organization admin.
     *
     * @return self
     */
     ...
     * Gets type
     *
     * @return \OpenAPI\Client\Model\HelloAssoApiV5CommonModelsEnumsOrganizationType|null
     */
     ...
     * Sets type
     *
     * @param \OpenAPI\Client\Model\HelloAssoApiV5CommonModelsEnumsOrganizationType|null $type type
     *
     * @return self
     */
