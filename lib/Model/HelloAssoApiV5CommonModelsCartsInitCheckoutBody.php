...
/**
 * HelloAssoApiV5CommonModelsCartsInitCheckoutBody Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class HelloAssoApiV5CommonModelsCartsInitCheckoutBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HelloAsso.Api.V5.Common.Models.Carts.InitCheckoutBody';
    ...
    protected static $openAPITypes = [
        ...
        'terms' => '\OpenAPI\Client\Model\HelloAssoApiV5CommonModelsCartsCheckoutTerm[]',
        'payer' => '\OpenAPI\Client\Model\HelloAssoApiV5CommonModelsCartsCheckoutPayer',
        'metadata' => 'mixed',
        'payment_options' => '\OpenAPI\Client\Model\HelloAssoApiV5CommonModelsCartsCheckoutPaymentOptions'
    ];
    ...
    */
    ...
    public function setItemName($item_name)
    {
        ...
        if ((mb_strlen($item_name) > 250)) {
            throw new \InvalidArgumentException('invalid length for $item_name when calling HelloAssoApiV5CommonModelsCartsInitCheckoutBody., must be smaller than or equal to 250.');
        }
        if ((mb_strlen($item_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $item_name when calling HelloAssoApiV5CommonModelsCartsInitCheckoutBody., must be bigger than or equal to 1.');
        }
    ...
    public function setBackUrl($back_url)
    {
        ...
        if ((mb_strlen($back_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $back_url when calling HelloAssoApiV5CommonModelsCartsInitCheckoutBody., must be bigger than or equal to 1.');
        }
    ...
    public function setErrorUrl($error_url)
    {
        ...
        if ((mb_strlen($error_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $error_url when calling HelloAssoApiV5CommonModelsCartsInitCheckoutBody., must be bigger than or equal to 1.');
        }
    ...
    public function setReturnUrl($return_url)
    {
        ...
        if ((mb_strlen($return_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $return_url when calling HelloAssoApiV5CommonModelsCartsInitCheckoutBody., must be bigger than or equal to 1.');
        }
     ...
     * Gets terms
     *
     * @return \OpenAPI\Client\Model\HelloAssoApiV5CommonModelsCartsCheckoutTerm[]|null
     */
     ...
     * Sets terms
     *
     * @param \OpenAPI\Client\Model\HelloAssoApiV5CommonModelsCartsCheckoutTerm[]|null $terms The list of future terms (if applicable)
     *
     * @return self
     */
     ...
     * Gets payer
     *
     * @return \OpenAPI\Client\Model\HelloAssoApiV5CommonModelsCartsCheckoutPayer|null
     */
     ...
     * Sets payer
     *
     * @param \OpenAPI\Client\Model\HelloAssoApiV5CommonModelsCartsCheckoutPayer|null $payer payer
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\HelloAssoApiV5CommonModelsCartsCheckoutPaymentOptions|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\HelloAssoApiV5CommonModelsCartsCheckoutPaymentOptions|null $payment_options payment_options
     *
     * @return self
     */
