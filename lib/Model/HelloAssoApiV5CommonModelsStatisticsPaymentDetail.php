...
/**
 * HelloAssoApiV5CommonModelsStatisticsPaymentDetail Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class HelloAssoApiV5CommonModelsStatisticsPaymentDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'HelloAsso.Api.V5.Common.Models.Statistics.PaymentDetail';
    ...
    protected static $openAPITypes = [
        ...
        'items' => '\OpenAPI\Client\Model\HelloAssoApiV5CommonModelsStatisticsPaymentItem[]',
        'display_data' => '\OpenAPI\Client\Model\HelloAssoApiV5CommonModelsStatisticsPaymentDisplayData',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('display_data', $data ?? [], null);
     ...
     *
     * @param \DateTime|null $card_expiration_date Card expiration date (only for card payments)
     *
     * @return self
     */
     ...
     * Gets items
     *
     * @return \OpenAPI\Client\Model\HelloAssoApiV5CommonModelsStatisticsPaymentItem[]|null
     */
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Model\HelloAssoApiV5CommonModelsStatisticsPaymentItem[]|null $items Items linked to this payment
     *
     * @return self
     */
     ...
     * Gets display_data
     *
     * @return \OpenAPI\Client\Model\HelloAssoApiV5CommonModelsStatisticsPaymentDisplayData|null
     */
     ...
     * Sets display_data
     *
     * @param \OpenAPI\Client\Model\HelloAssoApiV5CommonModelsStatisticsPaymentDisplayData|null $display_data display_data
     *
     * @return self
     */
    public function setDisplayData($display_data)
    {
        if (is_null($display_data)) {
            throw new \InvalidArgumentException('non-nullable display_data cannot be null');
        }
