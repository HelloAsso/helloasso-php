...
/**
 * HelloAssoModelsComplianceV2CommonAddressAddressModelSnapshot Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class HelloAssoModelsComplianceV2CommonAddressAddressModelSnapshot implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HelloAsso.Models.Compliance.V2.Common.Address.AddressModelSnapshot';
    ...
    */
     ...
     * Sets iso_country
     *
     * @param int|null $iso_country iso_country
     *
     * @return self
     */
    public function setIsoCountry($iso_country)
    {
        if (is_null($iso_country)) {
            array_push($this->openAPINullablesSetToNull, 'iso_country');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('iso_country', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
