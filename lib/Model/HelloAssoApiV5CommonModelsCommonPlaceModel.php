...
/**
 * HelloAssoApiV5CommonModelsCommonPlaceModel Class Doc Comment
 *
 * @category Class
 ...
 */
class HelloAssoApiV5CommonModelsCommonPlaceModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HelloAsso.Api.V5.Common.Models.Common.PlaceModel';
    ...
    */
    ...
    public function setCountry($country)
    {
        ...
        if (!is_null($country) && (mb_strlen($country) > 3)) {
            throw new \InvalidArgumentException('invalid length for $country when calling HelloAssoApiV5CommonModelsCommonPlaceModel., must be smaller than or equal to 3.');
        }
        if (!is_null($country) && (mb_strlen($country) < 3)) {
            throw new \InvalidArgumentException('invalid length for $country when calling HelloAssoApiV5CommonModelsCommonPlaceModel., must be bigger than or equal to 3.');
        }
