...
```php
organizationsOrganizationSlugFormsFormTypeFormSlugStatsGet($organization_slug, $form_slug, $form_type): \OpenAPI\Client\Model\HelloAssoApiV5CommonModelsFormsFormStatsModel
```
...
try {
    $result = $apiInstance->organizationsOrganizationSlugFormsFormTypeFormSlugStatsGet($organization_slug, $form_slug, $form_type);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling FormsApi->organizationsOrganizationSlugFormsFormTypeFormSlugStatsGet: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenAPI\Client\Model\HelloAssoApiV5CommonModelsFormsFormStatsModel**](../Model/HelloAssoApiV5CommonModelsFormsFormStatsModel.md)
